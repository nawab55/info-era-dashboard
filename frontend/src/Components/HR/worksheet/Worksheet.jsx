...
const Worksheet = () => {
  ...
  return (
    <section className="bg-slate-50 h-full mt-16 md:ml-52" >
      <form className="bg-emerald-200 p-4 space-y-4" onSubmit={handleSubmit} >
        <div className="p-4 text-center text-2xl bg-emerald-600 rounded-md shadow-xl shadow-emerald-500 text-white">
          Worksheet Form
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 py-5">
          <div className="">
            ...
            <select
              ...
              className="bg-teal-50 mt-1 block w-full p-2 border border-gray-300 shadow-xl shadow-emerald-400 rounded-md focus:border-blue-500 focus:outline-none"
            >
          ...
          <div className="mb-12">
            <label className="block text-sm font-medium text-gray-900">Work</label>
            <textarea
              name="work"
              value={formData.work}
              onChange={handleInputChange}
