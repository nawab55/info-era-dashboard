...
//       <div className="bg-sky-200 p-4 text-center text-black text-2xl font-bold border-b-2 border-black">Domain Reports</div>
//       <div className="p-4">
//         <div className="flex gap-6 mb-4"> 
//           <select value={year} onChange={handleYearChange} className="py-2 px-3 border border-black rounded shadow-md">
//             {renderYears()}
//           </select>
//           <select value={month} onChange={handleMonthChange} className="p-2 border border-black rounded shadow-md">
//             {renderMonths()}
//           </select>
//         </div>
...
//                 <th className="px-1 py-1 border border-black">Customer Mobile</th>
//                 <th className="px-1 py-1 border border-black">WhatsApp Number</th>
...
//                 <th className="px-1 py-1 border border-black">Renewable Amount</th>
...
const DomainReports = () => {
  ...
  const renderMonths = () => {
    const months = [<option key="" value="">Select Month</option>]; // Default option
    for (let m = 1; m <= 12; m++) {
      const date = new Date(year, m - 1, 1);
      const monthName = format(date, "MMMM");
      months.push(<option key={m} value={m}>{monthName}</option>);
