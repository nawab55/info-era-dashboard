...
//       <div className="bg-teal-200 p-5 text-center text-gray-700 shadow-lg">
//         Home
//       </div>
...
//         <div>Value</div>
//       </div>
//       <div className="bg-amber-100 mt-4 py-5 text-center text-gray-700 shadow-lg">
//         Box 1
//       </div>
//       <div className="bg-cyan-100 mt-4 py-5 text-center text-gray-700 shadow-lg">
//         Box 2
//       </div>
//       <div className="bg-green-100 mt-4 py-5 text-center text-gray-700 shadow-lg">
//         Box 3
//       </div>
