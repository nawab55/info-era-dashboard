...
const Worksheet = () => {
  ...
  return (
    <div className="min-h-screen flex-1 bg-gray-100 lg:p-10 p-2">
      <div className="w-full max-w-6xl border mx-auto bg-white rounded overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="relative group">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-4 py-3 bg-white border outline-none border-gray-300 rounded 
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-white border disabled:bg-gray-200 outline-none border-gray-300 rounded 
                focus:ring-2 focus:ring-blue-300 
                transition duration-300 ease-in-out 
                text-gray-700 appearance-none"
              >
          ...
          {/* Conditional Fields */}
          <div
            className={`overflow-hidden min-w-full grid gap-6 grid-cols-2 w-full transition-all duration-500 ease-in-out ${
          ...
          >
            ...
            <div
              className="flex items-center border-2 border-dashed border-blue-300 rounded-lg p-4
