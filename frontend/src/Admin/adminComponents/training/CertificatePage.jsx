...
const CertificatePage = React.forwardRef(({ certificateData }, ref) => {
  return (
    <div ref={ref} className="flex flex-col justify-between h-screen border border-gray-300 p-0">
      {/* Header Image */}
      <div>
        <img src={headerImage} alt="Certificate Header" className="w-full h-48" />
      </div>
      ...
      <div className="text-center mt-[-2.5rem]">
        <div className="w-full mb-2">
          ...
          <h4 className="mt-[-0.625rem] text-lg font-semibold">Info Era Software Services Pvt. Ltd.</h4>
        </div>
        ...
        <div className="w-full mb-2">
          <p className="text-lg">
            ...
            a student of <b>{certificateData.course}</b> Final Year from 
            <b> {certificateData.collegeName}</b> has successfully completed 
            his internship at <b>Info Era Software Services Pvt. Ltd.</b> 
            Patna from <b>{formatDate(certificateData.fromDate)}</b> to <b>{formatDate(certificateData.toDate)}</b>.
          </p>
        </div>
        ...
        <div className="w-full mb-2">
          <p className="text-lg">
            ...
            by <b>{certificateData.studentName}</b>, his conduct and 
            performance during this period was excellent.
          </p>
        </div>

        <div className="w-full mb-2">
          <p className="text-lg italic">&quot;We wish him all the best in his future endeavors&quot;</p>
        </div>
      ...
      {/* Footer Image */}
      <div>
        <img src={footerImage} alt="Certificate Footer" className="w-full h-20" />
      </div>
    </div>
  );
});
